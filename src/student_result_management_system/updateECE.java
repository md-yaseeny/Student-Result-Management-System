 ...
 * @author yasee
 */
public class updateECE extends javax.swing.JFrame {

    /**
     * Creates new form updateECE
     */
    public updateECE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Micro Electronics");
        ...
        jLabel7.setText("Electronics And Communications Engineering");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String dsp = jTextField2.getText();
        String analog = jTextField3.getText();
        String comm = jTextField4.getText();
        String proces = jTextField5.getText();
        String micro = jTextField6.getText();
        ...
        try {
            ...
            if(rs.next()){
//                (rollno,dsp,analog,communication,microprocessor,microelectronics)
                st.executeUpdate("update btech_ece set dsp='"+dsp+"',analog='"+analog+"',communication='"+comm+"',microprocessor='"+proces+"',microelectronics='"+micro+"' where rollno ='"+rollno+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateECE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
