 ...
 * @author yasee
 */
public class updateEL extends javax.swing.JFrame {

    /**
     * Creates new form updateEL
     */
    public updateEL() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Magnetics");

        jLabel6.setText("Electro Mechanics");
        ...
        jLabel7.setText("Electrical Engineering");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String analog = jTextField2.getText();
        String circuit = jTextField3.getText();
        String comm = jTextField4.getText();
        String magnet = jTextField5.getText();
        String electro = jTextField6.getText();
        ...
        try {
            ...
            if(rs.next()){
//                (rollno,analog,circuit,communication,magnetics,electromechanics)
                st.executeUpdate("update btech_el set analog='"+analog+"',circuit='"+circuit+"',communication='"+comm+"',magnetics='"+magnet+"',electromechanics='"+electro+"' where rollno='"+rollno+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateEL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
