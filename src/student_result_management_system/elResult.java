 ...
 * @author yasee
 */
public class elResult extends javax.swing.JFrame {

    /**
     * Creates new form elResult
     */
    public elResult() {
        initComponents();
    }
    public elResult(String branch, String rollno) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField13, new org.netbeans.lib.awtextra.AbsoluteConstraints(366, 327, 96, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(505, 320, 108, -1));

        jLabel27.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student_result_management_system/xyz.png"))); // NOI18N
        jLabel27.setText("jLabel27");
        jPanel1.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 700, 350));
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(48, 18, 97, -1));

        jTextField2.setEditable(false);
        jPanel2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(187, 15, 126, -1));

        jLabel4.setText("Branch");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(407, 18, 89, -1));

        jTextField4.setEditable(false);
        jPanel2.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(525, 15, 126, -1));

        jLabel2.setText("Name");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(48, 61, 97, -1));

        jTextField1.setEditable(false);
        jPanel2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(187, 58, 126, -1));

        jLabel5.setText("Gender");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(407, 61, 89, -1));

        jTextField5.setEditable(false);
        jPanel2.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(525, 58, 126, -1));

        jLabel3.setText("Roll Number");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(48, 105, 97, -1));
        ...
        jPanel2.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(187, 102, 126, -1));

        jLabel6.setText("Father Name");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(407, 105, 89, -1));

        jTextField6.setEditable(false);
        jPanel2.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(525, 102, 126, -1));

        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student_result_management_system/xyz.png"))); // NOI18N
        jLabel26.setText("jLabel26");
        jPanel2.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 700, 500));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 700, 150));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        // TODO add your handling code here:
            ...
            ResultSet rs = st.executeQuery("select * from student inner join btech_el where student.rollno='"+rollno+"' and btech_el.rollno='"+rollno+"'");
            if(rs.next()){
...
//                jTextField4.setText(rs.getString(3));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(elResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
